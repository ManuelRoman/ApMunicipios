...
/**
 * Develve el nombre de la comunidad autónoma del municipio seleccionado
 * Participa en la acción 2
 */
public class MostrarCCAAMun implements Accion{
	...
	public boolean ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		String nomMun = request.getParameter("nomMun");
		String respuesta = null;
		System.out.println("Solicitud de CCAA del municipio: " + nomMun);
		String json = null;
		this.error = null;
		...
		try {
			...
			respuesta = daoConsultas.getNombreCCAA(nomMun);
