...
/**
 * Muestra los datos de un municpio seleccionado
 * Participa en la acción 4
 */
public class MostrarDatMun implements Accion{
	...
	public boolean ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		String nombreMunicipio = request.getParameter("nomAnt");
		System.out.println("Municipio seleccionado: " + nombreMunicipio);
		String json = null;
		...
		try {
			...
			municipio = daoConsultas.getMunicipio(nombreMunicipio);
		...
		json = new Gson().toJson(datosMunicipio);
